...
const WhatsAppButton = () => {
  const phoneNumber = '+919423968288';
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 whatsapp-fixed max-w-[calc(100vw-2rem)]">
      <button
        onClick={handleWhatsAppClick}
        className="group relative bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-3 sm:p-4 shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-[#25D366]/50 whatsapp-pulse"
